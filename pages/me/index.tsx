...
export default function Index({ profile, repos }: { profile: ProfileIF, repos: Repository[] }) {
...
export function MainPage({ profile, repos }: { profile: ProfileIF, repos: Repository[] }) {
...
export function Overview({ profile, repos }: { profile: ProfileIF, repos: Repository[] }) {
    return (
        <>
